...
export default function CheckoutCard({ name, id, price, image, amount }) {
    ...
    <tr>
      ...
      <td data-column="Progress" className="table-row__td">
        <div className={`component_toCartCantidad ${!stock ? "disabled" : ""}`}>
          <div
            className={`toCartBoton1 menos1 ${amount === 1 ? "disabled" : ""}`}
            onClick={resta}
          >
            {" "}
            <h1
              className={`toCartBoton menos ${amount === 1 ? "disabled" : ""}`}
            >
              -
            </h1>
          </div>
          ...
          <div
            className={`toCartBoton mas ${amount === stock ? "disabled" : ""}`}
            onClick={suma}
          >
